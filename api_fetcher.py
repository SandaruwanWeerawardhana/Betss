...
VHORSE_API_2_URL = os.getenv("VHORSE_API_2_URL", "")

VGREYHOUND_API_1_URL = os.getenv("VGREYHOUND_API_1_URL", "")
VGREYHOUND_API_2_URL = os.getenv("VGREYHOUND_API_2_URL", "")
...
def fetch_api_7():
    """Featured races for Harness (HA) - future."""
    return _get(
        url=HARNESS_API_3_URL,
        label="API-7 (HA Future)",
    )


def fetch_api_8():
    """Featured races for Greyhound (DG) - today."""
    return _get(
        url=GRAYHOUND_API_1_URL,
        label="API-8 (DG Today)",
    )


def fetch_api_9():
    """Featured races for Greyhound (DG) - tomorrow."""
    return _get(
        url=GRAYHOUND_API_2_URL,
        label="API-9 (DG Tomorrow)",
    )
...
def fetch_api_12():
    """Featured virtual races for Horse (HR) - tomorrow."""
    return _get(
        url=VHORSE_API_2_URL,
        label="API-12 (VHR Tomorrow)",
    )


def fetch_api_13():
    """Featured virtual races for Greyhound (DG) - today."""
    return _get(
        url=VGREYHOUND_API_1_URL,
        label="API-13 (VDG Today)",
    )


def fetch_api_14():
    """Featured virtual races for Greyhound (DG) - tomorrow."""
    return _get(
        url=VGREYHOUND_API_2_URL,
        label="API-14 (VDG Tomorrow)",
    )
